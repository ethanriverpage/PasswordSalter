...
def staticsalting():
    ...
    print("Statically salted MD5 hash: " + staticsalthashobject.hexdigest() + " using salt: " + str(staticsaltfullstring))
...
def dynamicsalting():
    ...
    print("Dynamically salted MD5 hash: " + hash_object.hexdigest() + " using salt: " + fullstring)
